    ...
    <view v-if="isShow" class="picker">
        ...
        <view v-if="type != 'time'" class="picker-modal">
            ...
            >
                ...
                >
                    <view v-for="(week, index) in weeks" :key="index - 7" class="picker-calendar-view">
            ...
            <view class="picker-modal-footer">
                ...
                <view class="picker-modal-footer-btn">
                    <view class="picker-btn" :hover-stay-time="100" hover-class="picker-btn-active" @click="onCancel"
                        >取消</view
                    >
                    <view
                        class="picker-btn"
...
const DateTools = {
     ...
     */
    isSameDay: (a, b) =>
        a.getMonth() == b.getMonth() && a.getFullYear() == b.getFullYear() && a.getDate() == b.getDate(),
    /**
     * 格式化Date对象
     * @param d 日期对象
     * @param f 格式字符串
            ...
            if (this.checkeds.length == 2) {
                ...
                if (DateTools.isSameDay(this.checkeds[1], item.dateObj)) {
                    ...
                    if (this.isMultiSelect && this.showTips)
                        item.tips = item.bgStyle.type ? this.beginText + ' / ' + this.endText : this.endText;
